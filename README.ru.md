...
- **BC250_vcn-driver-FULL_lzma-FIXED_appended-at-end.bin** (алиас v007-active,
  `9d249397…`): тест позиции. Проверяет позицию диспетча.
  Вердикт: на полке, шьём если заглушка загрузится.
- **BC250_vcn-driver-STUB_no-hw-ops_appended-at-end.bin** (алиас v007r-noop,
  `0133a34b…`): дописанный контроль. Различает вставку и дописывание.
  Вердикт: на полке, шьём если заглушка встанет.
- **BC250_vcn-driver-FULL_safe-reads-only_appended-at-end.bin** (алиас
  ...
  сырые чтения. Вердикт: на полке, шьём если заглушка загрузится, а полный-дописанный встанет.
- **BC250_vcn-driver-FULL_deferred-to-readyboot_appended-at-end.bin** (алиас
  ...
  Вердикт: на полке, шьём если заглушка загрузится, а полный-дописанный и безопасный встанут.
